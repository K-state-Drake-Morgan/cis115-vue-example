...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock4(), createElementBlock4("ul", mergeProps4({
    ...
    }, null, 8, ["item", "root", "hasSubmenu", "label", "props"]))], 16, _hoisted_2), $options.isItemVisible(processedItem) && $options.isItemGroup(processedItem) ? (openBlock4(), createBlock(_component_MenubarSub, {
      key: 0,
